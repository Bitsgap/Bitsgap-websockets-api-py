...
class TestWSChartUpdateTrades(TestCase):
    ...
    authClient.subscribe_chart_data(market, pair, ChartType.ChartTrades, ChartScale.ChartMinute)
    authClient.subscribe_chart_data(market, pair, ChartType.ChartTrades, ChartScale.ChartHour)
    authClient.subscribe_chart_data(market, pair, ChartType.ChartTrades, ChartScale.ChartDay)
