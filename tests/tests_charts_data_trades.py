...
class TestWSChartDataTrades(TestCase):
    ...
    authClient.get_chart_data(market, pair, ChartType.ChartTrades, ChartScale.ChartMinute, '20190303')
    authClient.get_chart_data(market, pair, ChartType.ChartTrades, ChartScale.ChartHour, '201903')
